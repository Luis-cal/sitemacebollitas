...
var vents = {
    ...
    calculate_invoice: function () {
        ...
        $.each(this.items.products, function (pos, dict) {
            dict.pos = pos;
            dict.subtotal = dict.cant * parseFloat(dict.pui);
...
function formatRepo(repo) {
    ...
    var option = $(
        ...
        '<b>PU+Iva:</b> <span class="badge badge-warning">$' + repo.pui + '</span>' +
        '</p>' +
        '</div>' +
        '</div>' +
        '</div>');
...
$(function () {
    ...
    $('#date_joined').datetimepicker({ //Aqui se valida la fecha
        format: 'YYYY-MM-DD',
      ...
      $(document).ready(function(){
        ...
        function displayHTMLTable(results){
            ...
            for(var i=0;i<datos.length;i++){
                ...
                var row = datos[i];
               parseFloat(datos[i].id)
                 
               console.log(datos[i].pui);
            vents.add(datos[i])
